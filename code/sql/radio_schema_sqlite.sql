...
-- References broadcasters name for mediums table.
...
-- Creates table containing radiostactions, their parent entity (broadcaster),
...
-- Creates table for unified advertisements length references.
...
-- Create main table with ads emitted through radio stations across country.
